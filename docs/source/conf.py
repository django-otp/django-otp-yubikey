...
intersphinx_mapping = {
    ...
    'yubiotp': ('http://pythonhosted.org/YubiOTP/', None),
}
...
latex_documents = [
  ('index', 'django-otp-yubikey.tex', u'django-otp-yubikey Documentation',
...
man_pages = [
    ('index', 'django-otp-yubikey', u'django-otp-yubikey Documentation',
     [u'Peter Sagerson'], 1)
]
...
texinfo_documents = [
  ('index', 'django-otp-yubikey', u'django-otp-yubikey Documentation',
   u'Peter Sagerson', 'django-otp-yubikey', 'One line description of project.',
   'Miscellaneous'),
]
